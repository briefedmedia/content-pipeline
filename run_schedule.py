...
schedule.every().sunday.at("17:00").do(job, "1", "history")
schedule.every().monday.at("17:00").do(job, "1", "news")
schedule.every().monday.at("17:00").do(job, "1", "history")
schedule.every().tuesday.at("17:00").do(job, "1", "news")
schedule.every().tuesday.at("17:00").do(job, "1", "history")
...
schedule.every().wednesday.at("23:00").do(job, "1", "history")
schedule.every().thursday.at("23:00").do(job, "1", "news")
schedule.every().thursday.at("23:00").do(job, "1", "history")
schedule.every().friday.at("23:00").do(job, "1", "news")
schedule.every().friday.at("23:00").do(job, "1", "history")
schedule.every().saturday.at("23:00").do(job, "1", "news")
schedule.every().saturday.at("23:00").do(job, "1", "history")
